...
export default class Auth {
  ...
  auth0 = new auth0.WebAuth({
    domain: 'tsrpg.auth0.com',
    clientID: 'L0xzEZQIpWtPs0OvNUUPPEW3fj909PHp',
    redirectUri: process.env.NODE_ENV === 'http://localhost:3001/callback',
